...
class GetData():
    def __init__(self):
        PATH = '/home/intern3_2026_1/DeepTTC/GDSC_data/'
    ...
    def _split(self,df,col,ratio,random_seed):
        ...
        for instatnce in col_list:
            ...
            if train_data.shape[0] == 0:
                ...
                train_data = train_data._append(sub_train)
                test_data = test_data._append(sub_test)
        print('#' * 50)
    ...
    def Drug_Thred(self):
        ...
        for i in drugid2thred:
            id_li_append(i)
            PubChem_li_append(drugid2pubchemid[i])
            thred_li_append(drugid2thred[i])
    ...
    def _split_balance_binary(self,df,col,ratio,random_seed):
        ...
        combine_data = neg_data_append(down_pos_data)
    ...
    def ByBinary(self,random_num):
        ...
        for idx,row in drug_cell_df.iterrows():
            ...
            if (ic50 > drugid2thred[drug_id]):
                Binary_Drug_list_append(1)
            else:
                Binary_Drug_list_append(0)
        ...
        #     if ic50 > -2:
        #         Binary_IC50_list_append(1)
        #     else:
        #         Binary_IC50_list_append(0)
...
if __name__ == '__main__':
    ...
    rnafile ='/home/intern3_2026_1/DeepTTC/GDSC_data/Cell_line_RMA_proc_basalExp.txt'
    drugfile = '/home/intern3_2026_1/DeepTTC/GDSC_data/smile_inchi.csv'
